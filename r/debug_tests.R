...
print("No IV, CCK, SN")
print(G_restriction(W_data, A_matrix, theta, J0_vec, Vbar, NULL, 1, 'CCK', 'SN', alpha, num_boots, rng_seed))
print("No IV, CCK, SN2S")
print(G_restriction(W_data, A_matrix, theta, J0_vec, Vbar, NULL, 1, 'CCK', 'SN2S', alpha, num_boots, rng_seed))
