...
# - alpha           1 x 1             level of tests
# - bootstrap_replications             1 x 1             number of bootstrap draws
# - rng_seed                                seed for replication purpose
#
# - An_vec        bootstrap_replications x 1             vector as in eq. (4.25) in Andrews and Kwon (2023), only useful to compute c.value SPUR1
