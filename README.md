...
| :---------- | :---------- | :---------------------- | :-------------------------- | :--------- |
| 500         | SN2S        | \[-14.3, 22.6\]         | \[-40.0, 35.9\]             | 2.13       |
| 500         | EB2S        | \[-11.9, 21.7\]         | \[-40.0, 34.6\]             | 41.56      |
| 1000        | SN2S        | \[-40.0, 28.3\]         | \[-40.0, 57.4\]             | 1.74       |
| 1000        | EB2S        | \[-40.0, 26.8\]         | \[-40.0, 54.1\]             | 41.02      |

#### Table 2

| \(\Bar{V}\) | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :---------- | :---------- | :---------------------- | :-------------------------- | :--------- |
| 500         | SN2S        | \[-23.0, 17.1\]         | \[-40.0, 37.9\]             | 5.34       |
| 500         | EB2S        | \[-18.4, 14.3\]         | \[-40.0, 35.1\]             | 171.74     |
| 1000        | SN2S        | \[-40.0, 17.0\]         | \[-40.0, 37.9\]             | 5.08       |
| 1000        | EB2S        | \[-40.0, 13.9\]         | \[-40.0, 34.3\]             | 175.97     |
...
| \(\Bar{V}\) | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :---------- | :---------- | :---------------------: | :-------------------------: | :--------: |
| 500         | SN2S        |     \[-14.3, 22.6\]     |       \[-40.0, 35.9\]       |   1.101    |
| 500         | EB2S        |     \[-13.7, 22.3\]     |       \[-40.0, 34.5\]       |   31.318   |
| 1000        | SN2S        |     \[-40.0, 28.3\]     |       \[-40.0, 57.4\]       |   0.874    |
| 1000        | EB2S        |     \[-40.0, 27.4\]     |       \[-40.0, 54.1\]       |   29.824   |

#### Table 2

| \(\Bar{V}\) | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :---------- | :---------- | :---------------------: | :-------------------------: | :--------: |
| 500         | SN2S        |     \[-23.0, 17.1\]     |       \[-40.0, 37.9\]       |   1.416    |
| 500         | EB2S        |     \[-20.9, 16.0\]     |       \[-40.0, 35.3\]       |  120.004   |
| 1000        | SN2S        |     \[-40.0, 17.0\]     |       \[-40.0, 37.9\]       |   1.210    |
| 1000        | EB2S        |     \[-40.0, 14.5\]     |       \[-40.0, 34.2\]       |  120.320   |

#### Table 3

| \(\Bar{V}\) | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :---------- | :---------- | :---------------------: | :-------------------------: | :--------: |
| 0           | SN2S        |      \[nan, 14.2\]      |       \[-40.0, 12.8\]       |   1.028    |
| 0           | SN2S        |     \[-35.4, 44.0\]     |       \[-40.0, 13.8\]       |   1.169    |
| 0           | EB2S        |     \[-36.5, 43.4\]     |       \[-40.0, 12.6\]       |   31.440   |
| 0           | SPUR1       |     \[-40.0, 54.5\]     |       \[-40.0, 18.3\]       |  184.308   |
...
| Comp. Time    |                  | 0.532            | 0.858           | 0.724           | 0.754           |

#### Table 5

| \(\Bar{V}\) | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :---------- | :---------- | :---------------------: | :-------------------------: | :--------: |
| 500         | SN2S        |     \[-16.0, 23.0\]     |       \[-40.0, 39.0\]       |   2.328    |
| 500         | EB2S        |     \[-15.0, 22.0\]     |       \[-40.0, 39.0\]       |  421.224   |
| 1000        | SN2S        |     \[-40.0, 29.0\]     |       \[-40.0, 63.0\]       |   2.282    |
| 1000        | EB2S        |     \[-40.0, 27.0\]     |       \[-40.0, 61.0\]       |  408.990   |
