...
| :--------: | :---------: | :---------------------: | :-------------------------: | :--------: |
|    CCK     |  self-norm  |   \(14.2^{\dagger}\)    |      \[-40.0 , 12.8\]       |    25.5    |
|   RC-CCK   |  self-norm  |    \[-35.4 , 44.0\]     |      \[-40.0 , 13.8\]       |    36.2    |
|   RC-CCK   |  bootstrap  |    \[-35.6 , 43.3\]     |      \[-40.0 , 13.0\]       |    42.2    |
|   RC-CCK   |    SPUR1    |    \[-39.2 , 53.2\]     |      \[-40.0 , 17.0\]       |    52.9    |
...
| Comp. time |                   |        13.3         |        12.2         |         8.7         |         8.5         |

#### Table B2

|                  | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :--------------: | :---------: | :---------------------: | :-------------------------: | :--------: |
| \(\Bar{V}\)=500  |  self-norm  |    \[-16.0 , 23.4\]     |      \[-40.0 , 39.3\]       |    45.4    |
|                  |  bootstrap  |    \[-13.9 , 22.4\]     |      \[-40.0 , 38.5\]       |   183.2    |
| \(\Bar{V}\)=1000 |  self-norm  |    \[-40.0 , 29.1\]     |      \[-40.0 , 63.1\]       |    54.5    |
|                  |  bootstrap  |    \[-40.0 , 26.8\]     |      \[-40.0 , 60.2\]       |   220.0    |
...
| :---------- | :---------- | :---------------------- | :-------------------------- | :--------- |
| 500         | SN2S        | \[-14.3, 22.6\]         | \[-40, 35.9\]               | 2.10       |
| 500         | EB2S        | \[-11.9, 21.7\]         | \[-40, 34.6\]               | 45.57      |
| 1000        | SN2S        | \[-40, 28.3\]           | \[-40, 57.4\]               | 1.81       |
| 1000        | EB2S        | \[-40, 26.8\]           | \[-40, 54.1\]               | 44.88      |

#### Table 2

| \(\Bar{V}\) | Crit. Value | \(\theta_1\): Coca-Cola | \(\theta_2\): Energy Brands | Comp. Time |
| :---------- | :---------- | :---------------------- | :-------------------------- | :--------- |
| 500         | SN2S        | \[-23, 17.1\]           | \[-40, 37.9\]               | 5.95       |
| 500         | EB2S        | \[-18.4, 14.3\]         | \[-40, 35.1\]               | 179.33     |
| 1000        | SN2S        | \[-40, 17\]             | \[-40, 37.9\]               | 5.28       |
| 1000        | EB2S        | \[-40, 13.9\]           | \[-40, 34.3\]               | 181.23     |
