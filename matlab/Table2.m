...
%  - IV_matrix           n  x 4          matrix of instruments
...
specs{1} = {settings.Vbar{1}, settings.IV{1}, settings.test_stat{1}, settings.cv{1}}; % Vbar=500, IV=demographics, test0=CCK, cvalue = SN2S,

specs{2} = {settings.Vbar{1}, settings.IV{1}, settings.test_stat{1}, settings.cv{2}}; % Vbar=500, IV=demographics, test0=CCK, cvalue = EB2S,

specs{3} = {settings.Vbar{2}, settings.IV{1}, settings.test_stat{1}, settings.cv{1}}; % Vbar=1000, IV=demographics, test0=CCK, cvalue= SN2S,

specs{4} = {settings.Vbar{2}, settings.IV{1}, settings.test_stat{1}, settings.cv{2}}; % Vbar=1000, IV=demographics, test0=CCK, cvalue= EB2S,
...
for sim0 = 1:4
    ...
    parfor point0 = 1:size(sim.grid_Theta1, 1)
