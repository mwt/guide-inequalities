function salida = m_functionv3(W_data,Dist_data,A_matrix,theta,J0_vec,Vbar,IV,grid0)
% input: 
% - W_data    : n x d_W dim.
% - Dist_data : n x d_W dim.
% - A_matrix  : n x J0 dim.
% - theta     : (d_theta+d_mu) x 1 dim.: theta = (theta1,...,theta6,mu1,mu2)
...
% next line is taylored to our application
theta0 = theta(1:6);
mu0    = theta(7:8);
...
% end of new lines, I add these new vectors in the last lines.
...
if strcmp(IV,'Y')
    salida = [X2_data dist_u1 dist_l1 dist_u2 dist_l2];
elseif strcmp(IV,'Y1')
    salida = [X2_data dist_u1 dist_l1 dist_u2 dist_l2];
elseif strcmp(IV,'Y2')
    salida = [X2_data dist_u1 dist_l1 dist_u2 dist_l2];
