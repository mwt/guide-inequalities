...
%
% comment:
% - the moment function utilized in this function is an alternative to eq (28).
...
function salida = MomentFunct_Uv2(A_vec, D_vec, Dist_vec, Z_vec, J0_vec, theta, Vbar)
    ...
    if S0 ~= size(theta, 1)
        ...
        for jj0 = 1:J0
            ...
            salida(jj0) = ((A_vec(jj0) + g_theta) .* D_vec(jj0) - Vbar * (1 - D_vec(jj0))) .* Z_vec(jj0); % use g_theta instead of theta, see eq (28) and Section 8.2.3
        end
